            ...
            <div class="card-body">
                <form class="row g-3" id="storeProduct" action="{{Route('product.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input readonly type="number" name="productCode" class="form-control" value="{{isset($product) ? $product->productCode + 1 : 50001}}" placeholder="Id serial is : {{isset($product) ? $product->productCode + 1 : 50001}}">
                    </div>
                    <div class="col-md-6">
